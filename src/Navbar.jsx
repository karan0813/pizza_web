        ...
        <div className="lg:w-screen md:w-screen w-full bg-[#FFD684] h-16 flex justify-between px-20 items-center ">
            ...
            <div >
                <div className="flex items-center">
                    ...
                    <div>
                        {!cartopen ? <svg onClick={() => (setcartopen(true))} xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
                        </svg> : <svg onClick={() => (setcartopen(false))} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
